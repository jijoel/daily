...
return array(
    ...
    'js' => array(
        ...
        'highlightjs'       => '/vendor/js/highlight.pack.js',
        ...
        'jquery-multiselect'=> '/vendor/js/jquery.multiselect.js',
    ...
    'css' => array(
        ...
        'highlightjs'       => '/vendor/css/highlightjs/obsidian.css',
        'jasny-bootstrap'   => '/vendor/css/jasny-bootstrap.min.css',
        'jquery-jcrop'      => '/vendor/css/jquery.Jcrop.min.css',
        'jquery-multiselect'=> '/vendor/css/jquery.multiselect.css',

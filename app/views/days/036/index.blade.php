...
<p class="note">This is a study on Bootstrap forms, to show the effects of small, particular changes.  @include('partials.github')</p>
...
<p>Form with help block and label and control widths specified:</p>
<form class="form">
    <fieldset>
        <div class="form-group">
